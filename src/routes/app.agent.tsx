    ...
    <div className="flex h-screen">
      <aside className="w-64 shrink-0 border-r border-border/60 bg-surface/30 flex flex-col">
        <div className="p-3 border-b border-border/60">
          <Hint
            label="Start a fresh investigation. Each one has its own conversation thread and tool history."
            side="right"
          >
            <Button
              variant="outline"
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <div className="h-14 px-6 border-b border-border/60 flex items-center gap-2">
          ...
          <div className="ml-auto">
            <Hint
              label="Generate a professionally formatted PDF report of this entire session — executive summary, full transcript, tool calls, and conclusion."
              side="bottom"
            >
